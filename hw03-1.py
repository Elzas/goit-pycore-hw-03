...
# Приклад: Якщо сьогодні 5 травня 2021 року, виклик get_days_from_today("2021-10-09") повинен повернути −157, оскільки 9 жовтня 2021 року є на 157 днів пізніше від 5 травня 2021 року
...
def get_days_from_today(date_str):
    try:
        today = dt.date.today()
        some_date = dt.datetime.strptime(date_str, "%Y-%m-%d").date()
