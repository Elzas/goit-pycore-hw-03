...
users = [
    {"name": "John Doe",   "birthday": "1985.01.23"},
    {"name": "Jane Smith", "birthday": "1990.01.27"},
    {"name": "Alice",      "birthday": "1990.05.06"},
    {"name": "Bob",        "birthday": "1985.05.07"},
    {"name": "Carol",      "birthday": "1992.05.08"},
    {"name": "Dave",       "birthday": "1988.05.09"},
    {"name": "Erin",       "birthday": "1995.05.10"},
    {"name": "Frank",      "birthday": "2000.05.11"},
    {"name": "Grace",      "birthday": "1980.05.13"},
    {"name": "Henry",      "birthday": "1993.05.15"},
]
...
def get_upcoming_birthdays(users):
    ...
    for user in users:
        name = user["name"]
        birthday = dt.datetime.strptime(user["birthday"], "%Y.%m.%d").date()
        birthday_this_year = birthday.replace(year=today.year)

        if today <= birthday_this_year <= after_week:
